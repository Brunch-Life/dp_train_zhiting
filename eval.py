...
def forward_pass(data, policy):
    ...
    naction = policy(qpos, images, None, is_pad)
    RMSE = pytorch_rmse(action, naction)

    return {"RMSE": RMSE}


def pytorch_rmse(tensor1, tensor2):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        help="ckpt_dir",
        default="/iag_ad_01/ad/tangyinzhou/tyz/reward_diffusion_policy/diffusion_policy/data/diffusion_policy_checkpoints/"
        + now,
    )
    parser.add_argument(
        "--data_root",
    ...
    parser.add_argument(
        "--batch_size", action="store", type=int, help="batch_size", default=4
    )
    parser.add_argument("--seed", action="store", type=int, help="seed", default=0)
    parser.add_argument(
        "--num_steps", action="store", type=int, help="num_steps", default=100000
    )
    ...
    parser.add_argument(
        ...
        default="/iag_ad_01/ad/tangyinzhou/tyz/reward_diffusion_policy/diffusion_policy/data/diffusion_policy_checkpoints_pick_chunk20/policy_best.ckpt",
    )

    parser.add_argument(
        "--chunk_size", action="store", type=int, help="chunk_size", default=8
    )
    parser.add_argument(
        "--hidden_dim", action="store", type=int, help="hidden_dim", default=7
    )
